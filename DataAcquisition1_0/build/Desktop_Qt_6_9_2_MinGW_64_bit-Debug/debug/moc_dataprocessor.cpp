...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->processingProgress((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->processingCompleted((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(int , const QString & )>(_a, &DataProcessor::processingProgress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(bool )>(_a, &DataProcessor::processingCompleted, 1))
            return;
    }
}
...
// SIGNAL 0
void DataProcessor::processingProgress(int _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void DataProcessor::processingCompleted(bool _t1)
{
