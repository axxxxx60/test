...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DatabaseManager::*)(int , const QString & )>(_a, &DatabaseManager::progressUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DatabaseManager::*)(bool , const QString & )>(_a, &DatabaseManager::operationCompleted, 1))
            return;
    }
}
...
// SIGNAL 0
void DatabaseManager::progressUpdated(int _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void DatabaseManager::operationCompleted(bool _t1, const QString & _t2)
{
